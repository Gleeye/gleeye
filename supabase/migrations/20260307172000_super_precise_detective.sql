-- FINAL BOSS: ULTRA-SPECIFIC ACTIVITY LOGGER

-- 1. Helper for better humanization of specific values
...
-- 2. Improved Logger: Always captures Entity Name from any source
...
BEGIN
    ...
    -- Determine Entity Name - PRECISION MODE
        ...
        FOR _col IN SELECT jsonb_object_keys(_diff_json) LOOP
            ...
            IF _col_template IS NOT NULL THEN
                ...
                INSERT INTO public.pm_activity_logs (
                    ...
                    jsonb_build_object('description', _description, 'entity_name', _entity_name, 'type', TG_TABLE_NAME)
                );
