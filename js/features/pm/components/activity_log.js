 ...
 */
const vocabulary = { 'todo': 'Da Fare', 'in_progress': 'In Corso', 'blocked': 'Bloccato', 'review': 'In Revisione', 'done': 'Completata', 'attivita': 'Attività', 'task': 'Task' };
...
function renderTimelineItem(log, context = {}) {
    ...
    // Use the unified humanizer
    const human = humanizeActivity(log, { hideContainer: isDedicatedView });
