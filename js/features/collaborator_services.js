...
import { upsertCollaboratorService, deleteCollaboratorService } from '../modules/api.js?v=121';
...
export function initCollaboratorServiceModals() {
    ...
    async function refreshPage() {
        ...
        if (hash.includes('order-detail')) {
            ...
            if (orderId) {
                const { fetchCollaboratorServices, fetchAssignments } = await import('../modules/api.js?v=121');
                const { renderOrderDetail } = await import('./orders.js?v=121');
