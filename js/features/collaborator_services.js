...
import { upsertCollaboratorService, deleteCollaboratorService } from '../modules/api.js?v=156';
...
export function initCollaboratorServiceModals() {
    ...
    async function refreshPage() {
        ...
        if (hash.includes('order-detail')) {
            ...
            if (orderId) {
                const { fetchCollaboratorServices, fetchAssignments } = await import('../modules/api.js?v=156');
                const { renderOrderDetail } = await import('./orders.js?v=156');
