...
if (!window.__gleeye_state) {
    window.__gleeye_state = {
        ...
        impersonatedRole: sessionStorage.getItem('gleeye_impersonatedRole') || null,
        impersonatedCollaboratorId: sessionStorage.getItem('gleeye_impersonatedCollaboratorId') || null,
        sapServices: [],
        sapServiceAreas: [],
        sapServiceTypes: [],
