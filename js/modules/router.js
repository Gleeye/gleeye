        ...
        try {
            ...
            case 'pm':
                ...
                if (state.currentSubPage === 'commessa' && state.currentId) {
                    ...
                    import('../features/pm/commessa_detail.js?v=1244')
                        .then(async module => {
                            try {
                    ...
                    import('../features/pm/internal_list.js?v=1244')
                        .then(module => {
                    ...
                    import('../features/pm/components/hub_drawer.js?v=1244').then(m => {
                        m.openHubDrawer(state.currentId, null);
                    });
                    // Show dashboard in background
                    import('../features/pm/index.js?v=1244').then(module => {
