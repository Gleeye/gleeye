    ...
    setTimeout(async () => {
        ...
        try {
            ...
            case 'collaborator-services':
                ...
                import('../features/collaborator_services.js?v=2013').then(m => m.renderCollaboratorServices(contentArea));
                break;
            case 'assignment-detail':
                if (pageTitle) pageTitle.textContent = 'Dettaglio Incarico';
                import('../features/assignments.js?v=2013').then(m => m.renderAssignmentDetail(contentArea));
                break;
            case 'assignments':
                if (pageTitle) pageTitle.textContent = 'Incarichi';
                import('../features/assignments.js?v=2013').then(m => m.renderAssignmentsDashboard(contentArea));
                break;
            case 'my-assignments':
