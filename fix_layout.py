...
new_content = """<!-- 2. MAIN CONTENT AREA (Projects + Activities) -->
            <div class="hp-main-content-area custom-scrollbar" style="padding-top: 1rem;">
                 ...
                 <div class="hp-main-columns-container">
                     ${isCollaborator ? `
                     <!-- ==================== COLLABORATOR ==================== -->
                     <div style="flex: 2.4; display: flex; flex-direction: column; gap: 2rem;">
                         <!-- ROW 1: TOP BLOCKS (NO BOX - COMPACT & STABLE) -->
                         <div style="display: grid; grid-template-columns: 0.9fr 1.15fr; gap: 3rem; align-items: flex-start;">
                             <!-- Left: Tasks (Collab) -->
                             <div id="hp-pm-spaces-main-block" style="display: flex; flex-direction: column; padding: 0; max-width: 500px;">
                             ...
                             <div id="hp-internal-dashboard-block" style="display: flex; flex-direction: column; padding: 0; min-width: 400px;">
                         ...
                         <div style="display: flex; gap: 2rem;">
                             <div id="hp-collaborator-payments-box" class="hp-widget-panel" style="flex: 1; display: flex; flex-direction: column; padding: 1.5rem; background: rgba(255, 255, 255, 0.2); backdrop-filter: blur(20px); border: 1px solid rgba(255, 255, 255, 0.3); border-radius: 28px; box-shadow: 0 8px 32px 0 rgba(31, 38, 135, 0.07);">
                             ...
                             <div id="hp-collaborator-invoices-box" class="hp-widget-panel" style="flex: 1; display: flex; flex-direction: column; padding: 1.5rem; background: rgba(255, 255, 255, 0.2); backdrop-filter: blur(20px); border: 1px solid rgba(255, 255, 255, 0.3); border-radius: 28px; box-shadow: 0 8px 32px 0 rgba(31, 38, 135, 0.07);">
                                  <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1.25rem;">
                                      <h3 style="font-size: 1.15rem; font-weight: 600; color: #1e293b; margin: 0; display: flex; align-items: center; gap: 10px; letter-spacing: -0.01em;">
                     ...
                     ` : `
                      <!-- ==================== PARTNER / ADMIN ==================== -->
                      <!-- 3 COLUMNS GRID -->
                      <div style="display: grid; grid-template-columns: 1.1fr 0.9fr 1fr; gap: 2.5rem; width: 100%; align-items: flex-start; padding-bottom: 3rem;">
                          
                          <!-- Col 1: Commesse -->
                          <div id="hp-pm-spaces-main-block" style="display: flex; flex-direction: column; max-width: 850px;">
