...
new_content = """<!-- 2. MAIN CONTENT AREA (Projects + Activities) -->
            <div class="hp-main-content-area custom-scrollbar" style="padding-top: 1rem;">
                 ...
                 <div class="hp-main-columns-container">
                     ${isCollaborator ? `
                     <!-- ==================== COLLABORATOR ==================== -->
                     <div style="display: flex; flex-direction: column; gap: 2.5rem; flex: 1; width: 100%;">
                     ...
                     ` : `
                      ...
                      <div class="hp-dash-partner-main" style="padding-bottom: 3rem;">
                          ...
                          <div id="hp-internal-dashboard-block">
                              <div style="margin-bottom: 2rem; margin-top: 0.5rem; display: flex; align-items: center; gap: 10px; padding-left: 8px; flex-shrink: 0;">
                          ...
                          <div style="display: flex; flex-direction: column; gap: 2rem;">
                              ...
                              <!-- FEED BLOCK -->
                              <div id="hp-activity-feed-block" class="hp-widget-panel" style="flex: 1; display: flex; flex-direction: column; background: rgba(255, 255, 255, 0.2) !important; backdrop-filter: blur(20px) saturate(180%); -webkit-backdrop-filter: blur(20px) saturate(180%); border: 1px solid rgba(255, 255, 255, 0.3) !important; border-radius: 28px; padding: 1.5rem; box-shadow: 0 8px 32px 0 rgba(31, 38, 135, 0.07); min-height: 0;">
                 ...
                 <!-- COMMON FEED BLOCK (Used if Feed should be outside partner grid? No, Partner has it inside) 
                      WAIT! In my previous version, Collaborator ALSO had column 3 feed!
                      Let me re-read the screenshot layout.
                      The Collaborator screenshot has:
                      Row 1: "Riepilogo Task", "Attività interne", "Feed"!
                      Ahhh! The 'Feed' was on the RIGHT side of the Collaborator layout!
                 -->
