...
order_id = "18d1ba7e-fe9f-4d55-967c-fdc0060ca3a5"
url = f"https://whpbetjyhpttinbxcffs.supabase.co/rest/v1/orders?id=eq.{order_id}&select=id,order_number,payment_mode,deposit_percentage,balance_percentage,installments_count"
headers = {
